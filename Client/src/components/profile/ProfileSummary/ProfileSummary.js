      ...
      <div id="summaryCard" className="card">
        <div className="card-body bg-light">
          ...
          <div className="col text-center border-bottom">
            <h5 className="mb-3">{this.state.user.name}</h5>
            <div className="col text-center border-bottom"></div>
          ...
          <div className="col text-center border-bottom">
            ...
            <div className="form-check text-left mb-3">
              <input type="checkbox" className="form-check-input" id="typeCheck1"></input>
              <label className="form-check-label" for="typeCheck1">
                Rock
              </label>
              <input type="checkbox" className="form-check-input" id="typeCheck2"></input>
              <label className="form-check-label" for="typeCheck2">
                Pop
              </label>
              <input type="checkbox" className="form-check-input" id="typeCheck3"></input>
